	...
	return (
		<div className="bg-neutral-800 flex flex-row text-white h-screen">
			<div className="w-1/4 bg-gradient-to-br from-blue-200 to-blue-300 ">
				...
				<div className="ml-6 mt-4 text-black font-semibold">Gender - Male</div>
				<div className="ml-6 text-black font-semibold">DOB - 14/10/2005</div>
    ...
    <span className="text-neutral-800">Height</span>
			...
			<div className="px-16 py-8 w-3/4 flex flex-col space-y-4">
				...
				<div>
					...
					our utmost priority. At Vitalis, we prioritize providing top-notch
					facilities for our patients. We are committed to ensuring their
					comfort and well-being. Additionally, we implement robust measures to
					safeguard patient data, maintaining confidentiality and security at
					all times. Your trust is our utmost priority.{" "}
				</div>
