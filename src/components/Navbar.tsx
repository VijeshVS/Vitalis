    ...
    return (
        <div className="flex flex-row shadow-xl shadow-black justify-between bg-white">
            ...
            <div className="mr-6 p-2 flex flex-row justify-center items-center space-x-2 w-[180px]">
              <button className="text-black w-1/2  px-2 py-1 rounded-md hover:bg-gray-200 border-[1px] border-teal-800 duration-300 transition-all">Sign Up</button>
              <button className="text-white w-1/2 bg-teal-700 px-2 py-1 rounded-md hover:bg-teal-800 duration-300 transition-all">Log In</button>
            </div>
        </div>
    );
};
